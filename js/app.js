...
const data = [
  {
	...
	},
	{
	  ...
	  text: "I built an interactive photo gallery using JavaScript to create a search box and a lightbox. I became very excited about this particular project as I managed to use JavaScript for the very first time. I initially learned to programme with Python, so I knew the basics such as variables, conditional statements, functions, for loops, arrays, etc. However, JavaScript is a fascinating programming language, especially with the ECMAScript (ES6) syntax. I was introduced to JavaScript's popular library ‘jQuery' which is merely a more convenient version of JavaScript as there are codes that work the same way as JavaScript but shorter with jQuery. I used a jQuery plugin to create a lightbox for my photo gallery and decided to use JavaScript for the search function as I want to expand my knowledge further. Overall, I think this project is a perfect introduction to try out JavaScript before moving on to the next challenge.",
	...
	},
	{
	  ...
	  text: "I built an interactive web dashboard using JavaScript to create tables, charts and graphics and other features that boost user interactivity. I like this particular project as I was able to use all of the skills that I have learned and implement everything here. I used SASS to style the webpage, and I genuinely think this tool is just the best as I do not need to repeat many codes. I started to learn CSS Grid, and I think it is useful as I can use it to layout the webpage in a certain way. I used Grid to layout the navigation bar as row when users view it in mobile screen mode and column when seeing it in tablet and desktop screen mode. I used chart.js to create interactive charts as I learned Python before, I knew how to create charts but surprised to see how much it can do just by using JavaScript so I am glad that I can get to learn this. Using JavaScript to create local storage for the settings was interesting, for example, I was required to create a drop down select option for the time zone and save the settings to make sure it stays the same when the webpage refreshes. However, with the resources from Treehouse, I was able to tackle the problem. Overall, it was a fun project and glad that I learned a lot from it.",
	...
	},
	{
	  ...
	  text: "For this project challenge, I created an employee directory using JavaScript to link to a third-party API to access their data and display the employee profile onto my web page. I was able to learn a lot of new things such as the Callback function and AJAX. I started to use jQuery as I became more confident in JavaScript. After fetching the data, I need to display the profile to the webpage and created a modal when a user clicks on a particular profile. I used a For Each an array iteration to present the information such as the image, name, email, and city.  I also created a range of variables to make sure that the information is displayed correctly, for example, ensuring that the names are capitalised, and the date of birth in UK format.  I am glad that I get to do a project based on a third-party API and personally think that it is beneficial for me as I became more confident in tackling more challenging projects.",
